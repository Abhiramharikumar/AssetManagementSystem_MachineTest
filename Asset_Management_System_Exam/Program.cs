...
using Asset_Management_System_Exam.Model;
using Asset_Management_System_Exam.Repository;
...
namespace MachineTestCamp6
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<AssetManagementDbContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("Dec24Connection")));
